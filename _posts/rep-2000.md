...
This REP applies for all ROS 2 releases up to Kilted Kaiju.
From Lyrical Luth on, this information is provided in the release's documentation.
See for example [the platform support page for Lyrical Luth](https://docs.ros.org/en/lyrical/Releases/lyrical/supported-platforms.html).
