...
The first is to enable better collaboration between oru existing open source projects.
...
There are also many cases when someone may want to extend a ROS Distro in a binary compatible way.
Common use cases for this include:

* Releasing a custom hardware driver that they will redistribute to their customers
